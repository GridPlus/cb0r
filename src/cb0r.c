...
#define htole16(x) ((__uint16_t)(_x))
#define be16toh(x) __bswap16(x)
#define le16toh(x) ((__uint16_t)(_x))
#define htobe32(x) __bswap32(x)
#define htole32(x) ((__uint32_t)(_x))
#define be32toh(x) __bswap32(x)
#define le32toh(x) ((__uint32_t)(_x))
#define htobe64(x) __bswap64(x)
#define htole64(x) ((__uint64_t)(_x))
#define be64toh(x) __bswap64(x)
#define le64toh(x) ((__uint64_t)(_x))
#elif (BYTE_ORDER == BIG_ENDIAN)
#define htobe16(x) ((__uint16_t)(_x))
#define htole16(x) __bswap16(x)
#define be16toh(x) ((__uint16_t)(_x))
#define le16toh(x) __bswap16(x)
#define htobe32(x) ((__uint32_t)(_x))
#define htole32(x) __bswap32(x)
#define be32toh(x) ((__uint32_t)(_x))
#define le32toh(x) __bswap32(x)
#define htobe64(x) ((__uint64_t)(_x))
#define htole64(x) __bswap32(x)
#define be64toh(x) ((__uint64_t)(_x))
#define le64toh(x) __bswap32(x)
